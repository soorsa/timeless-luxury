...
const NumberInput: React.FC<NumberInputProps> = ({
  ...
  return (
    <div className="w-full text-left">
      {label && <div className={`text-sm mb-0.5 font-semibold`}>{label}</div>}

      <div className="relative">
        <div
          className={`flex items-center border rounded-xl overflow-hidden px-2 ${
            hasError
              ? "border-red-500"
              : theme === "dark"
              ? "border-gray-600"
              : "border-gray-200 focus-within:border-yellow-500"
